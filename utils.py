...
def forgot_username():
    try:
        ...
        if username_forgot_username:
            subject = 'Your Pebbles Username'
            message = f'Your Pebbles username is: {username_forgot_username}'
...
def forgot_password():
    try:
        ...
        if username_forgot_pw:
            subject = 'Your Pebbles New Password'
            message = f'Your new Pebbles password is: {random_password}. Please login and reset your password.'
